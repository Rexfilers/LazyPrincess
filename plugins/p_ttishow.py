        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ 𝙼𝙰𝙸𝙽 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 ↭  🔥', url='https://t.me/MOVIES_PROVIDE') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ 𝚁𝙴𝚀 𝙶𝚁𝙾𝚄𝙿 ↭  🔥', url='https://t.me/MOVIES_PROVIDE2') ]
                                                                                    ] )
                )
