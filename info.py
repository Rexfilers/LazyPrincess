...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>Fɪʟᴇ Uᴘʟᴏᴀᴅᴇᴅ Bʏ - [Movies Provide™](https://t.me/MOVIES_PROVIDE2)</b>⚡\n📝<b>Fɪʟᴇ ɴᴀᴍᴇ: </b><code>{file_name}</code>🌟 \n\n⚙️ <b>Sɪᴢᴇ: </b><code>{file_size}</code> ⚡  <b>Jᴏɪɴ Nᴏᴡ [MoviesProvide™](https://t.me/MOVIES_PROVIDE2)</b> ↭  🍁")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡<b>Fɪʟᴇ Uᴘʟᴏᴀᴅᴇᴅ Bʏ - [Movies Provide™](https://t.me/MOVIES_PROVIDE2)</b>⚡\n📝<b>Fɪʟᴇ ɴᴀᴍᴇ: </b><code>{file_name}</code>🌟 \n\n⚙️ <b>Sɪᴢᴇ: </b><code>{file_size}</code>⚡   <b>Jᴏɪɴ Nᴏᴡ [MoviesProvide™](https://t.me/MOVIES_PROVIDE2)</b> ↭  🍁")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Yᴏᴜʀ Qᴜᴇʀʏ: {query}</b> \n‌‌‌‌IMDb: \n\n</b>🏷 Tɪᴛʟᴇ: {title}\n🌟 Rᴀᴛɪɴɢ : {rating}/10\n🎭 Gᴇɴʀᴇs: {genres}\n📆 Yᴇᴀʀ: {year}\n⏰ Dᴜʀᴀᴛɪᴏɴ : {runtime}\n🎙️ Lᴀɴɢᴜᴀɢᴇs : {languages}\n\n ☞ ᴘᴏᴡᴇʀᴇᴅ ʙʏ - [ᴍᴏᴠɪᴇs ᴘʀᴏᴠɪᴅᴇ](https://t.me/MOVIES_PROVIDE)</b>")
