...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>Fɪʟᴇ Uᴘʟᴏᴀᴅᴇᴅ Bʏ - [ᴍ_ᴘ](https://t.me/MOVIES_PROVIDE2)</b>⚡\n📝<b>Fɪʟᴇ ɴᴀᴍᴇ: </b><code>{file_name}</code>🌟 \n\n⚙️ <b>Sɪᴢᴇ: </b><code>{file_size}</code>⚡ ☞  <b>ʝσเɳ ɳσω [MoviesProvide™](https://t.me/MOVIES_PROVIDE2)</b> ↭  💫")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "⚡<b>Fɪʟᴇ Uᴘʟᴏᴀᴅᴇᴅ Bʏ -  [ᴍ_ᴘ](https://t.me/MOVIES_PROVIDE2)</b>⚡\n📝<b>Fɪʟᴇ ɴᴀᴍᴇ: </b><code>{file_name}</code>🌟 \n\n⚙️ <b>Sɪᴢᴇ: </b><code>{file_size}</code>⚡  ☞ <b>ʝσเɳ ɳσω [MoviesProvide™](https://t.me/MOVIES_PROVIDE2)</b> ↭  💫")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Yᴏᴜʀ Qᴜᴇʀʏ: {query}</b> \n‌‌‌‌IMDb: \n\n</b>🏷 ᴛɪᴛʟᴇ: {title}\n🌟 ʀᴀᴛɪɴɢ : {rating}/10\n🎭 ɢᴇɴʀᴇs: {genres}\n📆 ʏᴇᴀʀ: {year}\n⏰ ᴅᴜʀᴀᴛɪᴏɴ : {runtime}\n🎙️ ʟᴀɴɢᴜᴀɢᴇs : {languages}\n\n ☞ ᴘᴏᴡᴇʀᴇᴅ ʙʏ - ᴍᴏᴠɪᴇs_ᴘʀᴏᴠɪᴅᴇ")
